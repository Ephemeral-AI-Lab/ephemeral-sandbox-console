...
export function fileList(
  ...
  return postJson<FileListResult>(fileUrl(sandboxId), args);
}
...
function fileUrl(sandboxId: string): string {
  return `/api/sandboxes/${encodeURIComponent(sandboxId)}/files/list`;
}
